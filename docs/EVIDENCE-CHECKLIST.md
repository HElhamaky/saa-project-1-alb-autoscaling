> **Step-by-step instructions for each screenshot are in
> [`EVIDENCE-CAPTURE.md`](EVIDENCE-CAPTURE.md).** This file explains the
> ordering strategy and the reasoning; that one is the operational runbook.
