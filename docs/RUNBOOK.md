...
terraform init
terraform plan -out=tfplan    # skim the resource count: 65 to add, 0 to destroy
...
Follow `EVIDENCE-CAPTURE.md` for the step-by-step; `EVIDENCE-CHECKLIST.md`
explains why the order is what it is. Then:
